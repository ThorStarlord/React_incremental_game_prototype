...
| GC-13 Beta | CURRENT ACTIVE PACKAGE | [`specification/Technical/GC13BetaTechnicalReadinessPreregistration.md`](../specification/Technical/GC13BetaTechnicalReadinessPreregistration.md), [`specification/Technical/BetaCompletionContract.md`](../specification/Technical/BetaCompletionContract.md), issue #109 | Deterministic hardening is active; BETA_PASS requires the contract's genuine human evidence floor. |
