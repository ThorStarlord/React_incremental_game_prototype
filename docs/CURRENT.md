...
| Relationship Capability Constellation | CURRENT AUTHORITY, bounded / HUMAN-UNVALIDATED | [`specification/Technical/RelationshipCapabilityConstellation.md`](../specification/Technical/RelationshipCapabilityConstellation.md) | Separates durable learned Traits from Player-owned doctrine focus; derives only the established Structural Steward / Countermodeler profiles; Quest/Dialogue gates remain explicit and fail-closed. |
