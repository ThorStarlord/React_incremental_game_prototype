...
| Relationship Capability Constellation | CURRENT AUTHORITY, bounded / HUMAN-UNVALIDATED | [`specification/Technical/RelationshipCapabilityConstellation.md`](../specification/Technical/RelationshipCapabilityConstellation.md), [`specification/Technical/CandidateATraitBuildcraftDepthImplementation.md`](../specification/Technical/CandidateATraitBuildcraftDepthImplementation.md) | Separates durable learned Traits from Player-owned doctrine focus; GC06-GC08 consume active doctrine at deliberate posture-setting points while GC09-GC10 preserve durable-pair culmination to avoid switch-tax. |
| Campaign One Trait catalogue disposition | CURRENT BOUNDED AUTHORITY / HUMAN-UNVALIDATED | [`specification/Technical/TraitCatalogDisposition.md`](../specification/Technical/TraitCatalogDisposition.md) | Curates historical Trait definitions as keep/rework/defer/remove_1_0 and defines explicit runtime-effect authority; retained data does not imply supported 1.0 gameplay. |
