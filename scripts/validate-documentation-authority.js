...
const completionAuthorityFiles = [
  ...
  'specification/Technical/FeatureCompletionConvergenceResult.md',
...
if (exists('docs/CURRENT.md')) {
  requireContains('docs/CURRENT.md', [
    ...
    'FeatureCompletionConvergenceResult.md',
...
requireContains('STATUS.md', [
  ...
  'BETA_PASS=NO',
  'BETA_CONVERGENCE / HUMAN_EVIDENCE',
...
requireContains('specification/Technical/GameCompletionRoadmap.md', [
  ...
  'active frontier is **GC-13 Beta**',
  'Alpha qualification',
  'Release Candidate',
  'No automatic M-number continuation',
]);

requireContains('specification/Technical/FeatureCompletionConvergenceResult.md', [
  'CURRENT RESULT / REPOSITORY-QUALIFIED / HUMAN-UNVALIDATED',
  'Build Validation:** #477',
  'Candidate B',
  'Candidate A',
  'Candidate C',
  'FEATURE_COMPLETE / HUMAN-UNVALIDATED',
  'GC-13 Beta convergence',
  'Procedural qualification is not mechanical enforcement',
]);
