...
// ============================================================================
// PROMPTS: "Funnel & Queue" Pattern
// ============================================================================

const INITIAL_PROMPT = `
@github Analyze this repository. It is a React/TypeScript incremental game prototype.

PHASE 1: BRAINSTORM & AUDIT
- Review the core loop, state management, UI, and incremental mechanics.
- Identify architectural gaps, missing progression systems, or performance bottlenecks.

PHASE 2: THE 3-FEATURE EXECUTION PLAN
From your analysis, distill and select the TOP 3 most impactful, distinct features or refactors to implement. 

Format them strictly as this Markdown checklist:
### Feature Queue
- [ ] Feature 1: [Short Name] - [1-2 sentences on what will be built and files affected]
- [ ] Feature 2: [Short Name] - [1-2 sentences on what will be built and files affected]
- [ ] Feature 3: [Short Name] - [1-2 sentences on what will be built and files affected]

CRITICAL RULES:
1. DO NOT write code, create branches, or open PRs yet.
2. Only output the analysis and the 3-item Feature Queue above.
3. End your reply by stating: "Plan locked. Ready to start Feature 1 on your signal."
`;
...
WORKFLOW:
1. SYNC: Fetch and pull the latest changes from 'main' so you build on the newest codebase.
2. BRANCH: Create a new branch named "feature/<short-name>".
3. IMPLEMENT: Use your file editing tools to implement code changes for THIS FEATURE ONLY.
4. VERIFY: Ensure TypeScript types, exports, and imports compile cleanly without runtime crashes.
5. COMMIT & PUSH: Commit with a clear message and push to remote.
6. PULL REQUEST: Create a PR targeting 'main'.
7. MERGE:
   - If your GitHub tool permits merging, merge the PR immediately.
   - If permissions prevent merging, leave the PR open and report: "PR open, requires manual merge".
8. STATUS REPORT:
   - Provide the PR link.
   - Print the updated Feature Queue with [x] for completed features and [ ] for remaining ones.
9. STOP: Halt execution here. Do NOT begin the next feature until the next prompt.
`;
