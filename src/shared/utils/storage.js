 ...
 */
export const saveGame = (gameState, createBackup = true) => {
  try {
    ...
    localStorage.setItem(STORAGE_KEYS.SAVE_TIMESTAMP, saveData.timestamp);
 ...
 */
export const loadGame = (useBackup = false) => {
  try {
 ...
 * @param {Object} columnLayout - The layout configuration to save
 * @returns {boolean} - Whether the save was successful
 */
 ...
 */
export const clearSave = (keepSettings = false) => {
  try {
 ...
 * @returns {Object|null} - Basic save info like timestamp and version
 */
