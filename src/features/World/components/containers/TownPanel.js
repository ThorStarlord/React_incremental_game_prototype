 ...
 * 
 * @param {Object} props
 * @param {string} props.regionId - ID of the region containing this location
 * @param {string} props.locationId - ID of the selected location
 * @param {Function} props.onBack - Callback when back button is clicked
 * @param {Function} props.onNpcSelect - Callback when NPC is selected
 */
const TownPanel = ({ regionId, locationId, onBack, onNpcSelect }) => {
